                ...
                uint8_t       crc8)
{
    ...
    HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_RESET); /**< Put chip select line low */
    ...
    HAL_GPIO_WritePin(UWB_CS_GPIO_Port, UWB_CS_Pin, GPIO_PIN_SET); /**< Put chip select line high */
    decamutexoff(stat);
    return 0;
